      ...
      <colgroup>
        ...
        <tbody>
          ...
          <tr>
            <th>새 비밀번호</th>
            <td>
            	<input type="password" class="w-96 input input-bordered w-full max-w-xs"  name="loginPw" placeholder="새 비밀번호를 입력해주세요."/>
            </td>
          </tr>
          <tr>
            <th>새 비밀번호 확인</th>
            <td>
            	<input type="password" class="w-96 input input-bordered w-full max-w-xs"  name="loginPwConfirm" placeholder="새 비밀번호 확인을 입력해주세요."/>
            </td>
          </tr>
          <tr>
            <th>이름</th>
